      ...
      <header className="border-b-2 border-nd-gold bg-nd-navy sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <a href="/cards" className="text-sm font-normal tracking-widest text-nd-gold hover:text-nd-white transition-colors hidden sm:inline-block">
              My Cards
            </a>
            ...
            >
              <button type="submit" className="text-sm font-normal tracking-widest text-nd-muted hover:text-nd-white transition-colors flex items-center gap-2 group">
